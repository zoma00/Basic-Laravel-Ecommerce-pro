    ...
    <div class="py-12">
        <div class="container">
            ...
            <form action="{{ route('brand.update', $brands->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="categoryName">Update Brand Name</label>
                    <input type="text" name="brand_name" class="form-control" 
                        id="categoryName" 
                        value="{{ old('brand_name', $brands->brand_name) }}">  <!-- Merge old() and category data -->
                ...
                <div class="form-group">
                    <label for="categoryName">Update Brand Image </label>
                    <input type="file" name="brand_image" class="form-control" 
                        id="brand_image" 
                        value="{{ old('brand_image', $brands->brand_image) }}">  <!-- Merge old() and category data -->
